    ...
    <div class="modal-content">
        ...
        <div class="card">
            ...
            <div class="card-footer">
                <button  onclick='submitAvatar();' class="button is-solid accent-button replace-button is-disabled">Use Picture</button>
            </div>
        </div>
...
<div id="upload-crop-profile-modal" class="modal upload-crop-profile-modal is-xsmall has-light-bg">
    ...
    <div class="modal-content">
            ...
            <div class="card">
                ...
                <div class="card-footer">
                    <button id="submit-profile-picture"  onclick='submitAvatar();' class="button is-solid accent-button is-fullwidth raised is-disabled">Submit Picture</button>
                </div>
            </div>
...
<div id="upload-crop-cover-modal" class="modal upload-crop-cover-modal is-large has-light-bg">
    ...
    <div class="modal-content">
        ...
        <div class="card">
            ...
            <div class="card-footer">
                <button id="submit-cover-picture" onclick='submitCoverPhoto();' class="button is-solid accent-button is-fullwidth raised is-disabled">Use
                    Picture</button>
            </div>
        </div>
