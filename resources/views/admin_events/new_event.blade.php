				...
				<form action="storeEvents" method="post" onsubmit="show()" enctype="multipart/form-data">
					...
					<div class="row">
						<div class="col-lg-6">
							...
							<div class="col mb-3">
								...
								<textarea class="form-control" value="{{ old('description') }}" min="{{ today() }}" id="description"
								 name="description" rows="3" required maxlength="150"></textarea>
							</div>
						</div>
						<div class="col-lg-6">
							<div class="col mb-3">
								<label for="expDate" class="form-label">Expiry Date</label>
								<input class="form-control" type="datetime-local" value="" id="expiry_date" name="expiry_date" required />
							</div>
							<div class="col mb-3">
								<label for="address" class="form-label">Address</label>
								<textarea class="form-control" id="address" name="address" rows="3" required>{{ old('description') }}</textarea>
							</div>
						</div>
					</div>
					<div class="row">
					...
					<div class="row">
						<div class="col-lg-4">
							...
							<input type="text" id="organizer" name="organizer_name" value="{{ old('organizer') }}" class="form-control"
						...
						<div class="col-lg-4">
							...
							<input type="text" id="organizer_website" name="organizer_website" class="form-control"
								placeholder="Enter website" value="{{ old('organizer_website') }}" />
						</div>
					</div>
			</div>
