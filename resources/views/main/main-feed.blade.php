            ...
            <div id="activity-feed" class="view-wrap true-dom is-hidden">
                <div class="columns">
                    ...
                    <div class="column is-3 is-hidden-mobile">
                        ...
                        <div class="card has-background-image is-bottom" data-background="{{ asset('assets/img/illustrations/characters/friends2.svg') }}" id="profile-card">
                            <div class="pc-first">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body no-padding">
                                ...
                                <div class="page-block transition-block">
                                    <img src="{{ asset('assets/img/groups/1.jpg') }}" data-demo-src="{{ asset('assets/img/icons/logos/fastpizza.svg') }}" data-page-popover="0" alt="">
                                    <div class="page-meta">
                                        <span>Trekking Club</span>
                                    </div>
                                ...
                                <!-- Recommended Page -->
                                <div class="page-block transition-block">
                                    <img src="{{ asset('assets/img/groups/2.jpg') }}" data-demo-src="{{ asset('assets/img/icons/logos/lonelydroid.svg') }}" data-page-popover="1" alt="">
                                    <div class="page-meta">
                                        <span>Sunday Bible Service</span>
                                    </div>
                                    <div class="add-page add-transition">
                                        <i data-feather="bookmark"></i>
                                    </div>
                                ...
                                <!-- Recommended Page -->
                                <div class="page-block transition-block">
                                    <img src="{{ asset('assets/img/groups/5.jpg') }}" data-demo-src="{{ asset('assets/img/icons/logos/metamovies.svg') }}" data-page-popover="2" alt="">
                                    <div class="page-meta">
                                        <span>Monthly Bake Sale</span>
                                    </div>
                                    <div class="add-page add-transition">
                                        <i data-feather="bookmark"></i>
                                    </div>
                                ...
                                <!-- Recommended Page -->
                                <div class="page-block transition-block">
                                    <img src="{{ asset('assets/img/groups/3.jpg') }}" data-demo-src="{{ asset('assets/img/icons/logos/nuclearjs.svg') }}" data-page-popover="3" alt="">
                                    <div class="page-meta">
                                        <span>Open House Club</span>
                                    </div>
                                    <div class="add-page add-transition">
                                        <i data-feather="bookmark"></i>
                                    </div>
                                ...
                                <!-- Recommended Page -->
                                <div class="page-block transition-block">
                                    <img src="{{ asset('assets/img/groups/56.jpg') }}" data-demo-src="{{ asset('assets/img/icons/logos/slicer.svg') }}" data-page-popover="4" alt="">
                                    <div class="page-meta">
                                        <span>Grill Club</span>
                                    </div>
                                    <div class="add-page add-transition">
                                        <i data-feather="bookmark"></i>
                                    </div>
                                        ...
                                        <div class="friends-list is-hidden">
                                            ...
                                            <div class="list-body">
                                                ...
                                                <div class="friend-block">
                                                    ...
                                                    <img class="friend-avatar" src="{{ asset('assets/img/avatars/dan.jpg') }}" data-demo-src="{{ asset('assets/img/avatars/dan.jpg') }}" alt="">
                                                ...
                                                <div class="friend-block">
                                                    ...
                                                    <img class="friend-avatar" src="https://via.placeholder.com/300" data-demo-src="{{ asset('assets/img/avatars/daniel.jpg') }}" alt="">
                                                ...
                                                <div class="friend-block">
                                                    ...
                                                    <img class="friend-avatar" src="{{ asset('assets/img/avatars/stella.jpg') }}" data-demo-src="{{ asset('assets/img/avatars/stella.jpg') }}" alt="">
                                                ...
                                                <div class="friend-block">
                                                    ...
                                                    <img class="friend-avatar" src="https://via.placeholder.com/300" data-demo-src="{{ asset('assets/img/avatars/david.jpg') }}" alt="">
                                                ...
                                                <div class="friend-block">
                                                    ...
                                                    <img class="friend-avatar" src="https://via.placeholder.com/300" data-demo-src="{{ asset('assets/img/avatars/nelly.png') }}" alt="">
                            ...
                            <div class="content-wrap">
                                ...
                                <div class="card-heading">
                                    ...
                                    <div class="user-block">
                                        <div class="image">
                                            <img src="{{ asset('assets/img/avatars/dan.jpg') }}" data-demo-src="{{ asset('assets/img/avatars/dan.jpg') }}" data-user-popover="1" alt="">
                                        </div>
                                        <div class="user-info">
                                            <a href="#">Dan Walker</a>
                                            <span class="time">July 4 2018, 01:03pm</span>
                                        </div>
                                    </div>
                                    <!-- Right side dropdown -->
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="post-image">
                                        <a data-fancybox="post1" data-lightbox-type="comments" data-thumb="{{ asset('assets/img/demo/unsplash/1.jpg') }}" href="{{ asset('assets/img/posts/4th.jpg') }}" data-demo-href="{{ asset('assets/img/demo/unsplash/1.jpg') }}">
                                            <img src="{{ asset('assets/img/posts/4th.jpg') }}" data-demo-src="{{ asset('assets/img/demo/unsplash/1.jpg') }}" alt="">
                                        </a>
                                        <!-- Action buttons -->
                                ...
                                <div class="card-footer">
                                    ...
                                    <div class="likers-group">
                                        <img src="{{ asset('assets/img/avatars/dan.jpg') }}" data-demo-src="{{ asset('assets/img/avatars/dan.jpg') }}" data-user-popover="1" alt="">
                                        <img src="{{ asset('assets/img/avatars/bobby.jpg') }}" data-demo-src="{{ asset('assets/img/avatars/bobby.jpg') }}" data-user-popover="4" alt="">
                                        <img src="{{ asset('assets/img/avatars/stella.jpg') }}" data-demo-src="{{ asset('assets/img/avatars/stella.jpg') }}" data-user-popover="5" alt="">
                                        <img src="{{ asset('assets/img/avatars/elise.jpg') }}" data-demo-src="{{ asset('assets/img/avatars/elise.jpg') }}" data-user-popover="7" alt="">
                                    </div>
                                    <!-- Followers text -->
                            ...
                            <div class="comments-wrap is-hidden">
                                ...
                                <div class="comments-body has-slimscroll">
                                    ...
                                    <div class="media is-comment">
                                        ...
                                        <div class="media-content">
                                            ...
                                            <div class="media is-comment">
                                                ...
                                                <div class="media-left">
                                                    <div class="image">
                                                        <img src="../assets/img/avatars/bobby.jpg" data-demo-src="assets/img/avatars/david.jpg" data-user-popover="4" alt="">
                                                    </div>
                                                </div>
                                                <!-- Content -->
                                                <div class="media-content">
                                    ...
                                    <div class="media is-comment">
                                        ...
                                        <div class="media-left">
                                            <div class="image">
                                                <img src="../assets/img/avatars/jenna.jpg" data-demo-src="assets/img/avatars/rolf.jpg" data-user-popover="13" alt="">
                                            </div>
                                        </div>
                                        <!-- Content -->
                                        <div class="media-content">
                                            ...
                                            <div class="media is-comment">
                                                ...
                                                <div class="media-left">
                                                    <div class="image">
                                                        <img src="../assets/img/avatars/bobby.jpg" data-demo-src="assets/img/avatars/rolf.jpg" data-user-popover="13" alt="">
                                                    </div>
                                                </div>
                                                <!-- Content -->
                                                <div class="media-content">
                                    ...
                                    <div class="media is-comment">
                                        ...
                                        <div class="media-left">
                                            <div class="image">
                                                <img src="../assets/img/avatars/jenna.jpg" data-demo-src="assets/img/avatars/lana.jpeg" data-user-popover="10" alt="">
                                            </div>
                                        </div>
                                        <!-- Content -->
                                        <div class="media-content">
                        ...
                        <div class="card is-post">
                            ...
                            <div class="content-wrap">
                                ...
                                <div class="card-heading">
                                    <div class="user-block">
                                        <div class="image">
                                            <img src="{{ asset('assets/img/avatars/stella.jpg') }}" data-demo-src="{{ asset('assets/img/avatars/stella.jpg') }}" data-user-popover="2" alt="">
                                        </div>
                                        <div class="user-info">
                                            <a href="#">Stella Bergmann</a>
                                            <span class="time">July 1 2018, 15:13pm</span>
                                        </div>
                                    </div>
                                    <!-- Right side dropdown -->
                                    <!-- /partials/pages/feed/dropdowns/feed-post-dropdown.html -->
                                    ...
                                    <div class="post-image">
                                        ...
                                        <div class="masonry-grid">
                                            ...
                                            <div class="masonry-column-left">
                                                <a data-fancybox="post3" data-lightbox-type="comments" data-thumb="assets/img/demo/unsplash/3.jpg" href="../assets/img/posts/1.jpeg" data-demo-href="assets/img/demo/unsplash/3.jpg">
                                                    <img src="../assets/img/posts/1.jpeg" data-demo-src="assets/img/demo/unsplash/3.jpg" alt="">
                                                </a>
                                            </div>
                                            <!-- Right column -->
                                            <div class="masonry-column-right">
                                                <a data-fancybox="post3" data-lightbox-type="comments" data-thumb="assets/img/demo/unsplash/5.jpg" href="../assets/img/posts/2.jpeg" data-demo-href="assets/img/demo/unsplash/5.jpg">
                                                    <img src="../assets/img/posts/2.jpeg" data-demo-src="assets/img/demo/unsplash/5.jpg" alt="">
                                                </a>
                                                <a data-fancybox="post3" data-lightbox-type="comments" data-thumb="assets/img/demo/unsplash/6.jpg" href="../assets/img/posts/3.jpeg" data-demo-href="assets/img/demo/unsplash/6.jpg">
                                                    <img src="../assets/img/posts/3.jpeg" data-demo-src="assets/img/demo/unsplash/6.jpg" alt="">
                                                </a>
                                            </div>
                                            <!-- Post actions -->
                                            <!-- /partials/pages/feed/buttons/feed-post-actions.html -->
                            ...
                            <div class="comments-wrap is-hidden">
                                ...
                                <div class="comments-body has-slimscroll">
                                    ...
                                    <div class="media is-comment">
                                        ...
                                        <div class="media-left">
                                            <div class="image">
                                                <img src="../assets/img/avatars/jenna.jpg" data-demo-src="assets/img/avatars/jenna.png" data-user-popover="0" alt="">
                                            </div>
                                        </div>
                                        <!-- Content -->
                                        <div class="media-content">
                                            ...
                                            <div class="media is-comment">
                                                ...
                                                <div class="media-left">
                                                    <div class="image">
                                                        <img src="../assets/img/avatars/bobby.jpg" data-demo-src="assets/img/avatars/lana.jpeg" data-user-popover="10" alt="">
                                                    </div>
                                                </div>
                                                <!-- Content -->
                                                <div class="media-content">
                                            ...
                                            <div class="media is-comment">
                                                ...
                                                <div class="media-left">
                                                    <div class="image">
                                                        <img src="../assets/img/avatars/dan.jpg" data-demo-src="assets/img/avatars/david.jpg" data-user-popover="4" alt="">
                                                    </div>
                                                </div>
                                                <!-- Content -->
                                                <div class="media-content">
                                            ...
                                            <div class="media is-comment">
                                                ...
                                                <div class="media-left">
                                                    <div class="image">
                                                        <img src="../assets/img/avatars/elise.jpg" data-demo-src="assets/img/avatars/mike.jpg" data-user-popover="12" alt="">
                                                    </div>
                                                </div>
                                                <!-- Content -->
                                                <div class="media-content">
                                    ...
                                    <div class="media is-comment">
                                        ...
                                        <div class="media-left">
                                            <div class="image">
                                                <img src="../assets/img/avatars/dan.jpg" data-demo-src="assets/img/avatars/daniel.jpg" data-user-popover="3" alt="">
                                            </div>
                                        </div>
                                        <!-- Content -->
                                        <div class="media-content">
                                ...
                                <div class="card-footer">
                                    <div class="media post-comment has-emojis">
                                        ...
                                        <div class="media-content">
                                            ...
                                            <div class="actions">
                                                <div class="image is-32x32">
                                                    <img class="is-rounded" src="../assets/img/avatars/jenna.jpg" data-demo-src="assets/img/avatars/jenna.png" data-user-popover="0" alt="">
                                                </div>
                                                <div class="toolbar">
                                                    <div class="action is-auto">
                                                        <i data-feather="at-sign"></i>
                    ...
                    <div class="column is-3">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body no-padding">
                                ...
                                <div class="story-block">
                                    <div class="img-wrapper">
                                        <img src="{{ asset('assets/img/avatars/bobby.jpg') }}" data-demo-src="{{ asset('assets/img/avatars/bobby.jpg') }}" data-user-popover="8" alt="">
                                    </div>
                                    <div class="story-meta">
                                ...
                                <div class="story-block">
                                    <div class="img-wrapper">
                                        <img src="{{ asset('assets/img/avatars/elise.jpg') }}" data-demo-src="{{ asset('assets/img/avatars/elise.jpg') }}"data-user-popover="6" alt="">
                                    </div>
                                    <div class="story-meta">
                            ...
                            <div class="card-body">
                                <div>
                                    <div class="birthday-avatar">
                                        <img src="{{ asset('assets/img/avatars/dan.jpg') }}" data-demo-src="{{ asset('assets/img/avatars/dan.jpg') }}" alt="">
                        ...
                        <div class="left-section">
                            ...
                            <div id="new-group-list" class="user-list has-slimscroll">
                                ...
                                <div class="friend-block" data-ref="ref-2">
                                    <img class="friend-avatar" src="https://via.placeholder.com/300" data-demo-src="../assets/img/avatars/daniel.jpg" alt="">
                                    <div class="friend-name">Daniel Wellington</div>
                                    <div class="round-checkbox is-small">
                                        <div>
                                ...
                                <div class="friend-block" data-ref="ref-4">
                                    <img class="friend-avatar" src="https://via.placeholder.com/300" data-demo-src="../assets/img/avatars/david.jpg" alt="">
                                    <div class="friend-name">David Kim</div>
                                    <div class="round-checkbox is-small">
                                        <div>
                                ...
                                <div class="friend-block" data-ref="ref-5">
                                    <img class="friend-avatar" src="https://via.placeholder.com/300" data-demo-src="../assets/img/avatars/nelly.png" alt="">
                                    <div class="friend-name">Nelly Schwartz</div>
                                    <div class="round-checkbox is-small">
                                        <div>
                                ...
                                <div class="friend-block" data-ref="ref-6">
                                    <img class="friend-avatar" src="../assets/img/avatars/elise.jpg" data-demo-src="../assets/img/avatars/elise.jpg"alt="">
                                ...
                                <div class="friend-block" data-ref="ref-7">
                                    <img class="friend-avatar" src="https://via.placeholder.com/300" data-demo-src="../assets/img/avatars/bobby.jpg" alt="">
                                ...
                                <div class="friend-block" data-ref="ref-8">
                                    <img class="friend-avatar" src="https://via.placeholder.com/300" data-demo-src="../assets/img/avatars/lana.jpeg" alt="">
                                ...
                                <div class="friend-block" data-ref="ref-9">
                                    <img class="friend-avatar" src="https://via.placeholder.com/300" data-demo-src="../assets/img/avatars/gaelle.jpeg" alt="">
                                ...
                                <div class="friend-block" data-ref="ref-10">
                                    <img class="friend-avatar" src="https://via.placeholder.com/300" data-demo-src="../assets/img/avatars/mike.jpg" alt="">
                ...
                <div class="card-body">
                    <div class="inner">
                        ...
                        <div class="right-section">
                            <div class="header">
                                <img src="../assets/img/avatars/jenna.jpg" data-demo-src="../assets/img/avatars/jenna.jpg" alt="">
                                <div class="user-meta">
                            ...
                            <div class="tabs-wrapper">
                                ...
                                <div class="tab-content has-slimscroll">
                                    <div class="media is-comment">
                                        <figure class="media-left">
                                            <p class="image is-32x32">
                                                <img src="../assets/img/avatars/dan.jpg" data-demo-src="{{ asset('assets/img/avatars/dan.jpg') }}" alt="" data-user-popover="1">
                                            </p>
                                        </figure>
                                        <div class="media-content">
                                    ...
                                    <div class="media is-comment">
                                        <figure class="media-left">
                                            <p class="image is-32x32">
                                                <img src="https://via.placeholder.com/300" data-demo-src="{{ asset('assets/img/avatars/david.jpg') }}" alt="" data-user-popover="4">
                                            </p>
                                        </figure>
                                        <div class="media-content">
                                    ...
                                    <div class="media is-comment">
                                        <figure class="media-left">
                                            <p class="image is-32x32">
                                                <img src="https://via.placeholder.com/300" data-demo-src="{{ asset('assets/img/avatars/rolf.jpg') }}" alt="" data-user-popover="17">
                                            </p>
                                        </figure>
                                        <div class="media-content">
                                ...
                                <div class="dropdown is-accent page-dropdown">
                                    <div>
                                        <div class="button page-selector">
                                            <img src="https://via.placeholder.com/150x150" data-demo-src="{{ asset('assets/img/avatars/hanzo.svg') }}" alt=""> <span>Css Ninja</span> <i
                                                    data-feather="chevron-down"></i>
                                        </div>
                                    </div>
                                    <div class="dropdown-menu" role="menu">
                                        <div class="dropdown-content">
                                            ...
                                            <div class="dropdown-item">
                                                <div class="media">
                                                    <img src="https://via.placeholder.com/150x150" data-demo-src="{{ asset('assets/img/icons/logos/nuclearjs.svg') }}" alt="">
                                                    <div class="media-content">
                                                        <h3>NuclearJs</h3>
                                            ...
                                            <div class="dropdown-item">
                                                <div class="media">
                                                    <img src="https://via.placeholder.com/150x150" data-demo-src="{{ asset('assets/img/icons/logos/slicer.svg') }}" alt="">
                                                    <div class="media-content">
                                                        <h3>Slicer</h3>
                    ...
                    <div class="shared-publication">
                        ...
                        <div class="publication-meta">
                            <div class="inner-flex">
                                <img id="share-modal-avatar" src="../assets/img/avatars/dan.jpg" data-demo-src="../assets/img/avatars/dan.jpg" data-user-popover="1" alt="">
