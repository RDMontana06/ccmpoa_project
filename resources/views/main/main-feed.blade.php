								...
								<div class="tabs-wrapper">
									...
									<div class="tab-content">
										...
										<div class="compose">
											...
											<div id="activities-suboption" class="is-autocomplete is-suboption is-hidden">
												...
												<div id="drinking-autocpl-wrapper" class="is-autocomplete is-activity is-hidden">
													<div class="control has-margin">
														<input id="drinking-autocpl" type="text" class="input is-subactivity"
												...
												<div id="watching-autocpl-wrapper" class="is-autocomplete is-activity is-hidden">
													<div class="control has-margin">
														<input id="watching-autocpl" type="text" class="input is-subactivity"
											...
											<div id="gif-suboption" class="is-autocomplete is-suboption is-hidden">
												<div id="gif-autocpl-wrapper" class="control is-gif-wrapper has-margin">
													...
													<div class="gif-dropdown">
														<div class="inner">
															<div class="gif-block">
																<img src="https://via.placeholder.com/478x344" data-demo-src="../assets/img/demo/gif/1.gif"
																	alt="">
																<img src="https://via.placeholder.com/478x344" data-demo-src="../assets/img/demo/gif/2.gif"
																	alt="">
																<img src="https://via.placeholder.com/478x344" data-demo-src="../assets/img/demo/gif/3.gif"
																	alt="">
																<img src="https://via.placeholder.com/478x344" data-demo-src="../assets/img/demo/gif/4.gif"
																	alt="">
															</div>
															<div class="gif-block">
																<img src="https://via.placeholder.com/478x344" data-demo-src="../assets/img/demo/gif/5.gif"
																	alt="">
																<img src="https://via.placeholder.com/478x344" data-demo-src="../assets/img/demo/gif/6.gif"
																	alt="">
																<img src="https://via.placeholder.com/478x344" data-demo-src="../assets/img/demo/gif/7.gif"
																	alt="">
																<img src="https://via.placeholder.com/478x344" data-demo-src="../assets/img/demo/gif/8.gif"
																	alt="">
															</div>
															<div class="gif-block">
																<img src="https://via.placeholder.com/478x344" data-demo-src="../assets/img/demo/gif/9.gif"
																	alt="">
																<img src="https://via.placeholder.com/478x344" data-demo-src="../assets/img/demo/gif/10.gif"
																	alt="">
																<img src="https://via.placeholder.com/478x344" data-demo-src="../assets/img/demo/gif/11.gif"
																	alt="">
																<img src="https://via.placeholder.com/478x344" data-demo-src="../assets/img/demo/gif/12.gif"
																	alt="">
															</div>
														</div>
													</div>
										...
										<div class="more-wrap">
											...
											<!-- Publish button -->
											<button id="publish-button" type="button" class="button is-solid accent-button is-fullwidth">
												Publish
											</button>
										</div>
									</div>
									...
									<div class="comments-wrap is-hidden">
										...
										<div class="comments-body has-slimscroll">
														...
														<div class="media-left">
															<div class="image">
																<img src="{{ asset('assets/img/avatars/bobby.jpg') }}"
																	data-demo-src="{{ asset('assets/img/avatars/david.jpg') }}" data-user-popover="4" alt="">
															</div>
														</div>
														<!-- Content -->
														<div class="media-content">
											...
											<div class="media is-comment">
												...
												<div class="media-left">
													<div class="image">
														<img src="{{ asset('assets/img/avatars/jenna.jpg') }}"
															data-demo-src="{{ asset('assets/img/avatars/jenna.jpg') }}" data-user-popover="13" alt="">
													</div>
												</div>
												<!-- Content -->
												<div class="media-content">
														...
														<div class="media-left">
															<div class="image">
																<img src="{{ asset('assets/img/avatars/elise.jpg') }}"
																	data-demo-src="{{ asset('assets/img/avatars/rolf.jpg') }}" data-user-popover="6" alt="">
															</div>
														</div>
														<!-- Content -->
														<div class="media-content">
													...
													<div class="media is-comment">
														...
														<div class="media-left">
															<div class="image">
																<img src="{{ asset('assets/img/avatars/bobby.jpg') }}"
																	data-demo-src="{{ asset('assets/img/avatars/rolf.jpg') }}" data-user-popover="13" alt="">
															</div>
														</div>
														<!-- Content -->
														<div class="media-content">
											...
											<div class="media is-comment">
												...
												<div class="media-left">
													<div class="image">
														<img src="{{ asset('assets/img/avatars/jenna.jpg') }}"
															data-demo-src="{{ asset('assets/img/avatars/jenna.jpg') }}" data-user-popover="10" alt="">
													</div>
												</div>
												<!-- Content -->
												<div class="media-content">
												...
												<div class="media-content">
													...
													<div class="actions">
														<div class="image is-32x32">
															<img class="is-rounded" src="" data-demo-src="{{ asset('assets/img/avatars/jenna.png') }}"
									...
									<div class="content-wrap">
										...
										{{-- <div class="card-heading">
											<div class="user-block">
												<div class="image">
													<img src="{{ asset('assets/img/avatars/stella.jpg') }}"
														data-demo-src="{{ asset('assets/img/avatars/stella.jpg') }}" data-user-popover="2" alt="">
												</div>
												<div class="user-info">
											...
											<div class="post-image">
												...
												<div class="masonry-grid">
													...
													<div class="masonry-column-left">
														<a data-fancybox="post3" data-lightbox-type="comments" data-thumb="assets/img/demo/unsplash/3.jpg"
															href="../assets/img/posts/1.jpeg" data-demo-href="assets/img/demo/unsplash/3.jpg">
															<img src="../assets/img/posts/1.jpeg" data-demo-src="assets/img/demo/unsplash/3.jpg" alt="">
														</a>
													</div>
													<!-- Right column -->
													<div class="masonry-column-right">
														<a data-fancybox="post3" data-lightbox-type="comments" data-thumb="assets/img/demo/unsplash/5.jpg"
															href="../assets/img/posts/2.jpeg" data-demo-href="assets/img/demo/unsplash/5.jpg">
															<img src="../assets/img/posts/2.jpeg" data-demo-src="assets/img/demo/unsplash/5.jpg" alt="">
														</a>
														<a data-fancybox="post3" data-lightbox-type="comments" data-thumb="assets/img/demo/unsplash/6.jpg"
															href="../assets/img/posts/3.jpeg" data-demo-href="assets/img/demo/unsplash/6.jpg">
										...
										{{-- <div class="card-footer">
											...
											<div class="likers-group">
												<img src="{{ asset('assets/img/avatars/dan.jpg') }}"
													data-demo-src="{{ asset('assets/img/avatars/dan.jpg') }}" data-user-popover="1" alt="">
												<img src="{{ asset('assets/img/avatars/bobby.jpg') }}"
													data-demo-src="{{ asset('assets/img/avatars/bobby.jpg') }}" data-user-popover="4" alt="">
												<img src="{{ asset('assets/img/avatars/stella.jpg') }}"
													data-demo-src="{{ asset('assets/img/avatars/stella.jpg') }}" data-user-popover="5" alt="">
												<img src="{{ asset('assets/img/avatars/elise.jpg') }}"
													data-demo-src="{{ asset('assets/img/avatars/elise.jpg') }}" data-user-popover="7" alt="">
											</div>
									...
									<div class="comments-wrap is-hidden">
										...
										<div class="comments-body has-slimscroll">
											...
											<div class="media is-comment">
												...
												<div class="media-left">
													<div class="image">
														<img src="" data-demo-src="assets/img/avatars/jenna.png" data-user-popover="0" alt="">
													</div>
												</div>
												<!-- Content -->
												<div class="media-content">
													...
													<div class="media is-comment">
														...
														<div class="media-left">
															<div class="image">
																<img src="" data-demo-src="assets/img/avatars/lana.jpeg" data-user-popover="10"
																	alt="">
															</div>
														</div>
														<!-- Content -->
													...
													<div class="media is-comment">
														...
														<div class="media-left">
															<div class="image">
																<img src="" data-demo-src="assets/img/avatars/david.jpg" data-user-popover="4"
																	alt="">
															</div>
														</div>
														<!-- Content -->
													...
													<div class="media is-comment">
														...
														<div class="media-left">
															<div class="image">
																<img src="" data-demo-src="assets/img/avatars/mike.jpg" data-user-popover="12"
																	alt="">
															</div>
														</div>
														<!-- Content -->
													...
													<div class="media is-comment">
														...
														<div class="media-left">
															<div class="image">
																<img src="" data-demo-src="" data-user-popover="2" alt="">
															</div>
														</div>
														<!-- Content -->
														<div class="media-content">
											...
											<div class="media is-comment">
												...
												<div class="media-left">
													<div class="image">
														<img src="" data-demo-src="assets/img/avatars/daniel.jpg" data-user-popover="3" alt="">
													</div>
												</div>
												<!-- Content -->
												<div class="media-content">
											...
											<div class="media is-comment">
												...
												<div class="media-left">
													<div class="image">
														<img src="" data-demo-src="assets/img/avatars/bobby.jpg" data-user-popover="8" alt="">
													</div>
												</div>
												<!-- Content -->
												<div class="media-content">
										...
										<div class="card-footer">
											<div class="media post-comment has-emojis">
												...
												<div class="media-content">
													...
													<div class="actions">
														<div class="image is-32x32">
															<img class="is-rounded" src="" data-demo-src="" data-user-popover="0" alt="">
														</div>
														<div class="toolbar">
															<div class="action is-auto">
																<i data-feather="at-sign"></i>
							...
							<div class="left-section">
								...
								<div id="new-group-list" class="user-list has-slimscroll">
									...
									<div class="friend-block" data-ref="ref-1">
										<img class="friend-avatar" src="" data-demo-src="" alt="">
									...
									<div class="friend-block" data-ref="ref-2">
										<img class="friend-avatar" src="https://via.placeholder.com/300" data-demo-src="" alt="">
								...
								<div class="columns is-multiline" id="previews">
									...
									<div id="template" class="column is-4 is-template">
										<div class="preview-box">
											...
											<div>
												<span class="preview"><img src="https://via.placeholder.com/120x120" data-dz-thumbnail
														alt="" /></span>
											</div>
										...
										<div class="dropdown is-spaced is-right dropdown-trigger">
											...
											<div class="dropdown-menu has-margin" role="menu">
												<div class="dropdown-content">
													...
													<a href="#" class="dropdown-item">
														<div class="media">
															<img src="https://via.placeholder.com/478x344" data-demo-src="" alt="">
															<div class="media-content">
																<h3>Css Ninja</h3>
								...
								<div class="tabs-wrapper">
									...
									<div class="tab-content has-slimscroll">
										<div class="media is-comment">
											<figure class="media-left">
												<p class="image is-32x32">
													<img src="" data-demo-src="{{ asset('assets/img/avatars/dan.jpg') }}" alt=""
														data-user-popover="1">
												</p>
											</figure>
											<div class="media-content">
										...
										<div class="media is-comment">
											<figure class="media-left">
												<p class="image is-32x32">
													<img src="https://via.placeholder.com/300" data-demo-src="{{ asset('assets/img/avatars/david.jpg') }}"
										...
										<div class="media is-comment">
											<figure class="media-left">
												<p class="image is-32x32">
													<img src="https://via.placeholder.com/300" data-demo-src="{{ asset('assets/img/avatars/rolf.jpg') }}"
					...
					<div class="share-inputs">
						<div class="field is-autocomplete">
							<div id="share-to-friend" class="control share-channel-control is-hidden">
								<input id="share-with-friend" type="text" class="input is-sm no-radius share-input simple-users-autocpl"
						...
						<div class="field is-autocomplete">
							<div id="share-to-group" class="control share-channel-control is-hidden">
								<input id="share-with-group" type="text" class="input is-sm no-radius share-input simple-groups-autocpl"
						...
						<div id="share-to-page" class="control share-channel-control no-border is-hidden">
							<div class="page-controls">
										...
										<div>
											<div class="button page-selector">
												<img src="https://via.placeholder.com/150x150"
													data-demo-src="{{ asset('assets/img/avatars/hanzo.svg') }}" alt=""> <span>Css Ninja</span> <i
													data-feather="chevron-down"></i>
											</div>
										</div>
										<div class="dropdown-menu" role="menu">
											<div class="dropdown-content">
												<div class="dropdown-item">
													<div class="media">
														<img src="https://via.placeholder.com/150x150"
															data-demo-src="{{ asset('assets/img/avatars/hanzo.svg') }}" alt="">
														<div class="media-content">
															<h3>Css Ninja</h3>
												...
												<div class="dropdown-item">
													<div class="media">
														<img src="https://via.placeholder.com/150x150"
															data-demo-src="{{ asset('assets/img/icons/logos/nuclearjs.svg') }}" alt="">
														<div class="media-content">
															<h3>NuclearJs</h3>
								...
								<div class="alias">
									<img src="https://via.placeholder.com/150x150" data-demo-src="" alt="">
								</div>
							</div>
						</div>
						...
						<div class="field is-autocomplete">
							<div id="share-to-private-message" class="control share-channel-control is-hidden">
								<input id="share-with-private-message" type="text"
									class="input is-sm no-radius share-input simple-users-autocpl" placeholder="Message a friend">
								<div class="input-heading">
									To :
								</div>
							</div>
					...
					<div class="card-body">
						...
						<div class="shared-publication">
							<div class="featured-image">
								<img id="share-modal-image" src="https://via.placeholder.com/1600x900" data-demo-src="" alt="">
							</div>
							<div class="publication-meta">
								<div class="inner-flex">
									<img id="share-modal-avatar" src="" data-demo-src="" data-user-popover="1" alt="">
